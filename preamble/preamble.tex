...
\usepackage[
    ...
    maxbibnames=3, % Increase/decrease to include more/fewer authors in the bibliography
...
\makeindex[
    ...
    % title = Index,
    options = -s preamble/indexPreamble.ist, % Each section in the index will be accompanied by their first letter (capital) in boldface
    intoc, % Index in TOC
