...
\usepackage[
    ...
    sorting=none, % No sorting of bibliography entries (i.e. numerical order)
    % dashed=false, % No dash instead of author if the same author on article n and n+1
    maxbibnames=5, % Increase/decrease to include more/fewer authors in the bibliography
...
\newcommand{\half}{\nicefrac{1}{2}} % Nice half frac in text
