...
\documentclass[paper=a4, fontsize=12pt, twoside, openright, titlepage=firstiscover,DIV=10]{scrbook}

% Document class is the Koma script report class
% \documentclass[paper=a4, fontsize=12pt, DIV=10]{scrreprt}
...
\setboolean{book}{true} % Sets the value of the boolean ''book'' to either true or false
